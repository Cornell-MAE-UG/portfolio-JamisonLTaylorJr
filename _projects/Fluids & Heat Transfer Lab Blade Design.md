...
![Figure 1: CAD model and dimensions]({{ "/assets/images/blade-cad.jpg" | relative_url }}){: .inline-image-r style="width: 200px"}
...
![Figure 2: plot of baseline/tuned free spin root bending stress vs. wind speed]({{ "/assets/images/free-spin-root-bending-stress.jpg" | relative_url }}){: .inline-image-r style="width: 200px"}
...
![Figure 3: plot of baseline/tuned chord and twist vs. radius]({{ "/assets/images/chord-and-twist.jpg" | relative_url }}){: .inline-image-r style="width: 200px"}

![Figure 4: superimposed power curve plots for 8-11hz]({{ "/assets/images/superimposed-power-curve.jpg" | relative_url }}){: .inline-image-r style="width: 200px"}
...
![Figure 5: all plot of power curves with max power and corresponding RPM]({{ "/assets/images/average-power.jpg" | relative_url }}){: .inline-image-r style="width: 200px"}
